...
const sectionTypes = [
  ...
  { label: t('admin.courseMaterialGrid'), value: 'course_material', icon: 'i-lucide-book-open' },
  { label: t('admin.serviceAreas'), value: 'service_areas', icon: 'i-lucide-map-pin' },
  { label: t('admin.contactMethodsGrid'), value: 'contact_methods', icon: 'i-lucide-phone-call' },
  { label: t('admin.contactFormMap'), value: 'contact_form_map', icon: 'i-lucide-map' },
  { label: t('admin.socialMediaGrid'), value: 'social_media', icon: 'i-simple-icons-tiktok' },
