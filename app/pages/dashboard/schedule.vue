...
// Helper function to check if a slot's date and time is in the past
              ...
              <div>
                ...
                <div class="space-y-2 max-h-[300px] overflow-y-auto pr-1">
                  <button
                    ...
                    :key="slot.id"
                    :disabled="!slot.available"
                    class="w-full p-3 text-left border rounded-lg transition-all text-sm flex items-center justify-between"
                    :class="[
