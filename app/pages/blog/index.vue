...
const filteredArticles = computed(() => {
  ...
  const base = publishedArticles.value;
...
const remainingPosts = computed(() => blogPosts.value.slice(1));
...
<template>
  <div>
    <!-- Hero Section -->
    <section
      class="relative overflow-hidden bg-gradient-to-br from-warning/5 via-background to-warning/10"
    >
      <div class="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          class="absolute -top-24 -right-24 size-96 bg-warning/5 rounded-full blur-3xl"
        />
        <div
          class="absolute -bottom-32 -left-32 size-[500px] bg-warning/3 rounded-full blur-3xl"
        />
      </div>
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
      ...
      <div v-if="blogPosts.length === 0" class="py-24 text-center">
        <div
          class="inline-flex items-center justify-center size-20 rounded-full bg-muted/30 mb-6"
        >
      ...
      <template v-else>
        ...
        >
          <div
            class="grid lg:grid-cols-2 gap-6 lg:gap-10 items-center p-2 rounded-3xl border border-default bg-elevated/50 hover:bg-elevated transition-all duration-300 hover:shadow-xl hover:shadow-warning/5"
          >
            <!-- Image / Thumbnail -->
            ...
            <div class="p-4 lg:p-6 lg:pr-10">
              ...
              <h2
                class="text-2xl lg:text-3xl font-bold mb-4 group-hover:text-warning transition-colors line-clamp-2"
              >
                {{ featuredPost.title }}
              </h2>
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          >
            <div
              class="flex flex-col h-full rounded-2xl border border-default bg-elevated/30 overflow-hidden hover:bg-elevated hover:shadow-lg hover:shadow-warning/5 transition-all duration-300 hover:-translate-y-1"
            >
              <!-- Image -->
              ...
              <div class="flex flex-col flex-1 p-5">
                ...
                <!-- Title -->
                <h3
                  class="text-lg font-semibold mb-2 group-hover:text-warning transition-colors line-clamp-2"
                >
                  {{ post.title }}
                </h3>
