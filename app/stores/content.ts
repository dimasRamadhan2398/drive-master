...
import type { BlogPostMedia, CreateBlogPostData, UpdateBlogPostData, CreateBlogArticleData } from "~/services/contentService";

// Re-export types from contentService for convenience
export type { BlogPostMedia, CreateBlogPostData, UpdateBlogPostData, CreateBlogArticleData };
  ...
  actions: {
    ...
    async fetchBlogPosts(params: {
      ...
      try {
        ...
        // Backend returns "articles" in BlogArticleListResponse
        const posts = (result as any).articles || result.posts || [];
