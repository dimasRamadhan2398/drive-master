...
### Module A: Course & Scheduling Management
...
| Paket | Hari | Transmisi | Base Price (Day) | Night | Weekend |
|---|---|---|---:|---|---|
| 6x | Weekday | Matic | 1,750,000 | Base Price + Rp 100.000 | Base Price + Rp 100.000 |
| 8x | Weekday | Matic | 1,950,000 | Base Price + Rp 150.000 | Base Price + Rp 150.000 |
| 10x | Weekday | Matic | 2,250,000 | Base Price + Rp 200.000 | Base Price + Rp 200.000 |
| 12x | Weekday | Matic | 2,650,000 | Base Price + Rp 250.000 | Base Price + Rp 250.000 |

**Packages (Session)**
| Field | Type | Description |
|---|---|---|
| `id` | UUID | Primary key |
| `package_name` | UUID | FK → Course |
| `operate_on` | UUID | FK → Instructor |
| `transmission` | Enum | "automatic", "manual" |
| `base_price` | int64 | Package Base Price |
| `night_price` | String | Package Night Price |
| `weekend_price` | Integer | Package Weekend Price |
| `extra_sessions` | Enum | `open`, `full`, `cancelled`, `completed` 

- Day time window: **08.00 - 17.00 WIB**
- Night time window: **18.00 - 20.00 WIB**
- Weekend time window: **08.00 - 17.00 WIB**
- Private/Extra sessions: **Rp 250.000/hour**
