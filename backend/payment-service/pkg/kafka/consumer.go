...
func NewConsumer(cfg ConsumerConfig, logger *zap.Logger) (*Consumer, error) {
	...
	config.Consumer.Group.Session.Timeout = 10 * 1000 * 1000 * 1000
	config.Consumer.Group.Heartbeat.Interval = 3 * 1000 * 1000 * 1000
	config.Consumer.MaxProcessingTime = 5 * 1000 * 1000 * 1000

	config.Consumer.Fetch.Min = 1
	config.Consumer.Fetch.Default = 1024 * 1024
	config.Consumer.MaxWaitTime = 500 * 1000 * 1000

	config.Consumer.Offsets.Initial = sarama.OffsetNewest
	config.Consumer.Offsets.AutoCommit.Enable = true
	config.Consumer.Offsets.AutoCommit.Interval = 1 * 1000 * 1000 * 1000
